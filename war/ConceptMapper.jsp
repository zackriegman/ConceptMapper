...
<html>
  <head>
    ...
    <!--                                                               -->
    <link type="text/css" rel="stylesheet" href="ConceptMapper.css">
    ...
    <!--                                           -->
    <script type="text/javascript" language="javascript" src="conceptmapper/conceptmapper.nocache.js"></script>
  </head>
